...
function ResetZoomFront() {
    ...
    strHtml += "    position: absolute; padding: 0px; width: 237px; height: 307px;' class='map'>";
    ...
    strHtml += "     <img border='0' style='height: 307px; margin-left: 20px;' class='mappedObject'";
...
function setImage(id) {
    ...
    if (id == "aPelvis") {
        $("#divafterZoom").css({ 'margin-top': '-725px', position: 'relative', 'margin-left': '-541px', height: '1450px' });
        $("#ImgMan").css({ 'margin-top': '0px', position: 'relative', 'margin-left': '0', height: '1450px' });
    }
